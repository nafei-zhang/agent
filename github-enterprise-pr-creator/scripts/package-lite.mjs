...
const targetDir = path.join(skillsRoot, "github-enterprise-pr-creator-lite");
...
async function writeMinimalPackageJson() {
  const minimalPackage = {
    name: "github-enterprise-pr-creator-skill-lite",
    version: "1.0.0",
    private: true,
    type: "module",
    description: "Prebuilt release for enterprise PR skill (no npm install required)"
  };
